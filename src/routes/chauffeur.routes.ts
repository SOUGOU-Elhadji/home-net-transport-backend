...
router.post("/", authenticate as any, authorize(["SUPER_ADMIN", "ADMIN"]) as any, createChauffeur as any);
router.put("/:id", authenticate as any, authorize(["SUPER_ADMIN", "ADMIN"]) as any, updateChauffeur as any);
