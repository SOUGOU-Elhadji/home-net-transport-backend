...
router.post("/", authenticate as any, authorize(["SUPER_ADMIN", "ADMIN"]) as any, createInvoice as any);
router.put("/:id/status", authenticate as any, authorize(["SUPER_ADMIN", "ADMIN"]) as any, updateInvoiceStatus as any);
